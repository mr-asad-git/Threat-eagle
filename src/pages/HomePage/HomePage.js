...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-40 px-6"
      ...
      {/* Main content wrapper to ensure single parent */}
      <>
                        ...
                        {selected.type === 'File' ? (
                          ...
                          <div className="flex flex-col w-full gap-4">
                            <textarea
                              ...
                              className="w-full h-40 p-4 text-yellow-300 border-2 border-yellow-400 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-400 transition-all duration-300 bg-black/80 font-mono"
                              value={codeInput}
                            ...
                            <button
                              ...
                              onClick={() => {
                                ...
                                navigate('/scan/code', { 
                                  state: { code: codeValue },
                                  search: `?value=${encodeURIComponent(codeValue)}`
                                });
                              }}
                              className="w-full px-6 py-3 rounded-xl bg-yellow-400 text-black font-bold text-base shadow-lg transition-all duration-300 border-2 border-yellow-400 hover:bg-yellow-500 hover:border-yellow-500 focus:outline-none"
                            >
                              Scan Code
                            </button>
                          </div>
                          ...
                          <>
                            <input
                              ...
                              type="text"
                              placeholder={selected.placeholder}
                              className="w-full h-10 p-2 text-black border-2 text-yellow-500 border-yellow-400 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-400 transition-all duration-300 bg-transparent"
                            />
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {[ 
                  ...
                  <motion.button
                    ...
                    className="bg-black/80 text-yellow-300 py-4 px-6 w-[160px] rounded-xl shadow-md font-semibold text-md transition-all duration-700"
  ...
  function AccordionItem({ title, content }) {
    ...
    return (
      <div className="border-b border-yellow-400 last:border-none">
        <button
        ...
        {open && (
          <div className="px-4 pb-5 text-yellow-200 text-base animate-fade-in">
            {content}
          </div>
        )}
      </div>
